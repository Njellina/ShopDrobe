...
public class SunnySize extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sunnysize);
                ...
                switch (checkedId) {
                    ...
                    case R.id.radioS:
                        addcart.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Boolean insert = db.insertCart(uname, "Sunny Dress", "IDR 170.000", "S");
                                if (insert == true) {
                    ...
                    case R.id.radioM:
                        addcart.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Boolean insert = db.insertCart(uname, "Sunny Dress", "IDR 170.000", "M");
                                if (insert == true) {
                                    Toast.makeText(getApplicationContext(), "Insert Successful!", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(getApplicationContext(), Shop.class));
                                } else {
                    ...
                    case R.id.radioL:
                        addcart.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Boolean insert = db.insertCart(uname, "Sunny Dress", "IDR 170.000", "L");
                                if (insert == true) {
                                    Toast.makeText(getApplicationContext(), "Insert Successful!", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(getApplicationContext(), Shop.class));
                                } else {
                    ...
                    case R.id.radioXL:
                        addcart.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Boolean insert = db.insertCart(uname, "Sunny Dress", "IDR 170.000", "XL");
                                if (insert == true) {
                                    Toast.makeText(getApplicationContext(), "Insert Successful!", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(getApplicationContext(), Shop.class));
                                } else {
